...
import { PS } from "./microprocessor";
export interface Coordinate {
  row: number;
  column: number;
};

type AudioPeripherals = (Lcd & Fire & Speaker) | (Lcd & Speaker) | (Lcd & PixelDisplay & Fire & Speaker) | (Speaker & Fire);
type LcdPeripherals = (Lcd & Fire & Speaker) | (Lcd & Speaker) | (Lcd & PixelDisplay & Fire & Speaker) | Lcd | (Lcd & Fire);
type FirePeripherals = (Lcd & Fire) | (Lcd & Fire & Speaker) | (Lcd & PixelDisplay & Fire & Speaker);
